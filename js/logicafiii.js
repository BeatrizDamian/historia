var app = new Vue({
		...
		data:{
			...
			frase:["hoces","plata","vacas","caballo","producto"]
		},	//	End datos
			...
			comparar: function(caracter,posicion){
				...
				if(this.contador_aciertos==this.palabra_generada.length){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anieme/boythere/ganador.png" alt="Ganaste">`,
	                ...
	                this.game = false
						...
						Swal.fire({
											...
											html: `<img class="img-fluid" src="../anime/boythere/ganador.png" alt="Ganaste">`,
											confirmButtonText: "Volver a Jugar",
											confirmButtonColor:'#00CC33',
											allowOutsideClick: false,
											allowEscapeKey: false,
				...
				if(this.contador_errores==5){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anime/boythere/perdedor.png" alt="Ganaste">`,
										confirmButtonText: "Volver a Jugar",
										confirmButtonColor:'#00CC33',
										allowOutsideClick: false,
										allowEscapeKey: false,
