var app = new Vue({
		...
		data:{
			...
			frase:["pacífico","capitanías","centroamérica","tenochtitlan","migración"]
		},	//	End datos
			...
			comparar: function(caracter,posicion){
				...
				if(this.contador_aciertos==this.palabra_generada.length){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anime/girlone/ganador.png" alt="Ganaste">`,
				...
				if(this.contador_errores==5){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anime/girlone/perdedor.png" alt="Ganaste">`,
										confirmButtonText: "Volver a Jugar",
										confirmButtonColor:'#00CC33',
										allowOutsideClick: false,
										allowEscapeKey: false,
