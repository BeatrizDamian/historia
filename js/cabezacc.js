...
document.getElementById('countdown').innerHTML = totalTime;
    if(totalTime==0){
      console.log('Final');
      Swal.fire({
          title: "¡Formaste la  Historia!",
          html: `<img class="img-fluid" src="../img/ganaste.png" alt="Ganaste">`,
  ...
  var virrey = document.getElementById("virrey");
  	...
  	function testing() {
  		...
  		if(bien_ubicada == 9){
  			virrey.play();
  			Swal.fire({
  					title: "¡Formaste la  Historia!.100 puntos",
  					html: `
